...
you should place your code here."
  ...
  ;;set SPC j N to join two lines together
  (spacemacs/set-leader-keys "jN" 'join-line)
  ;;set SPC x a x to align regexp in selected region
  (spacemacs/set-leader-keys "xax" 'align-regexp)
  (setq omnisharp-server-executable-path "C:\\Program Files (x86)\\OmniSharp-Roslyn\\OmniSharp.exe") 
  ;;auto call the remove-dos-eol function when a c sharp file is opened.Sorts out mixed line ending issues
